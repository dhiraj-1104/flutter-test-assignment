...
// in flutter_assignment/test/lib/features/users/domain/usecases/get_user_usecase_test.dart.
...
class MockUserRepository extends _i1.Mock implements _i2.UserRepository {
  ...
  @override
  _i3.Future<List<_i4.User>> getUser(int? page) =>
      (super.noSuchMethod(
            Invocation.method(#getUser, [page]),
